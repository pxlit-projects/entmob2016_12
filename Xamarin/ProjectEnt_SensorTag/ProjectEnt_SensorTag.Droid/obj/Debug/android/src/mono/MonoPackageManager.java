...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "ProjectEnt_SensorTag.Droid.dll" comes first in this list. */
		"ProjectEnt_SensorTag.Droid.dll",
		"Behaviors.dll",
		"FormsViewGroup.dll",
		"Newtonsoft.Json.dll",
		"PCLCrypto.dll",
		...
		"ProjectEnt_SensorTag.Network.dll",
	};
